...
abline(v=0.3, col = "red", lwd=2, lty=2)
```
![Histograma de la distribucion de las muestras](../plots/histograma_1.png)
...
abline(v = 0.3, col="red", lwd=2, lty=2)
```
![Histograma de la distribucion de las muestras despues del cutoff](../plots/histograma_2.png)
...
ggplot(as.data.frame(colData(rse_gene)), aes(y = assigned_gene_prop, col = sra_attribute.phenotype, x = sra_attribute.phenotype)) +
    ...
    xlab("Fenotipo")
```
![Boxplot de expresion diferencial entre el control y MDD](../plots/boxplot_fenotipo.png)
...
ggplot(as.data.frame(colData(rse_gene)), aes(y = assigned_gene_prop, col = sra_attribute.gender, x = sra_attribute.gender)) +
    ...
    xlab("Genero")
```
![Boxplot de expresion diferencial entre el genero de los individuos](../plots/boxplot_genero.png)
...
```
![Boxplot de expresion diferencial entre las causas de muerte](../plots/boxplot_muerte.png)
...
```
![Desviacion estandar de los datos](../plots/voom_1.png)
...
```
![Cambio de expresion del control y pacientes con MDD](../plots/plotMA.png)
...
```
![Genes con mayor expresion y mejor p-value](../plots/volcano_plot.png)
...
```
![Expresion de los 50 genes mas significativos](../plots/heatmap.png)
...
```
![Clustering por genero](../plots/plot_mds_cluster_por_genero.png)
...
```
![Clustering por fenotipo](../plots/plot_mds_cluster_por_fenotipo.png)
...
```
![Clustering por causa de muerte](../plots/plot_mds_cluster_por_muerte.png)
